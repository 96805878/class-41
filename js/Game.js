class Game {
  ...
  start() {
    ...
    //Adding fuel sprites
    this.addSprites(5,fuelImage,0.02,fuelGroup)
    //Adding coin sprites
    this.addSprites(20,powerCoinImage,0.09,coinGroup)
    //Adding obstacles
    ...
    this.addSprites(obstaclePositions.length,obstacle1Img,0.04,obstacleGroup,obstaclePositions)
  }
  ...
  handleFuel(carIndex){
    cars[carIndex-1].overlap(fuelGroup,function(car, fuel){
      player.fuel=200
      fuel.remove()
    })
  ...
  handleCoin(carIndex){
    ...
    cars[carIndex-1].overlap(coinGroup,function(car,coin){
  ...
  displayRank(){
    swal({
      title:"Congratulations! You are rank "+player.rank,
  ...
  displayLife(){
    ...
    push()
    image(lifeImg,width/2-130,height-player.positionY-380,20,20);
    noStroke();
    fill("white");
    rect(width/2-100,height-player.positionY-380,200,15);
    fill("red");
    rect(width/2-100,height-player.positionY-380,player.life,15);
    pop();
  }
  ...
  displayFuelbar(){
    ...
    noStroke();
    fill("white");
    rect(width/2-100,height-player.positionY-340,200,15);
    fill("red");
    rect(width/2-100,height-player.positionY-340,player.fuel,15);
    pop();
  }
